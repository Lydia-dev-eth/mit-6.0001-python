...
class Message(object):
    ...
    def apply_pad(self, pad):
        ...
        for i in range(len (pad)):
            cipher_text += self.shift_char(self.input_text[i], pad[i])
...
class PlaintextMessage(Message):
    ...
    def generate_pad(self):
        ...
        generated_pad= [random.randint(0,109)for i in range(len(self.input_text))]
        '''
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        return PlaintextMessage(self.apply_pad(inverse_pad),pad)
